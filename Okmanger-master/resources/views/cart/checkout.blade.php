...
<div class="container">
    ...
    @endif
        <div class="field">
            ...
            <input class="input is-success" id="adr" name="adresse" value="{{ old('adresse') ?? $information->adresse }}" placeholder="ex : 4 Rue de Rivoli">
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input is-success" id="fname" name="numappart" value="{{ old('numappart') ?? $information->numappart }}" placeholder="ex : Appartement n°20">
                <span class="icon is-small is-right">
                    <i class="fas fa-check"></i>
                </span>
            </div>
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input is-success" id="email" name="digicode" value="{{ old('digicode') ?? $information->digicode }}" placeholder="ex : C83748 ">
                <span class="icon is-small is-right">
                    <i class="fas fa-check"></i>
                </span>
            </div>
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input is-success" id="city" name="ville" value="{{ old('ville') ?? $information->ville }}" placeholder="ex : Paris">
                <span class="icon is-small is-right">
                    <i class="fas fa-check"></i>
                </span>
            </div>
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input is-success" id="zip" name="codepostale" value="{{ old('codepostale') ?? $information->codepostale }}" placeholder="ex : 75004">
                <span class="icon is-small is-right">
                    <i class="fas fa-check"></i>
                </span>
            </div>
            ...
            <div class="field" style="width: 64rem;">
                <label  class="label">Choisissez votre heure de livraison</label>
                <div class="control has-icons-left has-icons-right">
                    <select class="input is-success" name="heurelivraison">
                        <option value="Livrasion 11h">Livrasion 11h</option>
                        <option value="Livrasion 11h">Livrasion 11h</option>
                        <option value="Livrasion 11h">Livrasion 11h</option>
                        <option value="Livrasion 11h">Livrasion 11h</option>
                        <option value="Livrasion 11h">Livrasion 11h</option>
        ...
        @if($information->ville == null)
        <center> <button type="submit" class="button is-info">Enregister les informations</button></center>
        @else
        <center> <button type="submit" class="button is-info">Mettre a jour les informations</button></center>
        @endif
    </form>
    <br>
    ...
    <div id="a_masquer" style="display:none">
        <form action="/charge" method="post" id="payment-form">
            @csrf
            <div class="">
                <input type="hidden" name="amount" value="{{$carts->totalPrice }}">
            ...
            <center> <button class="button is-info">Valider payement</button></center>
                    ...
                    <div class="box">
                        <div class="columns">
                            ...
                            <div class="column gras">Produit: {{ $cart['title'] }}</div>
                            <div class="column gras">Qté: {{ $cart['qty'] }}</div>
                            <div class="column gras">Prix unitaire: {{ $cart['price'] }}€</div>
                            @endforeach
                        ...
                        <div class="field is-grouped">
                            ...
                            <p class="control is-expanded">
                               <center><input class="input" type="text" placeholder="Code Promo" name="coupon_code" id="coupon_code" disabled></center>
                            </p>
                            <p class="control">
                                <a >
                                    <center><button class="button is-info" type="submit" disabled> Confirmer</button></center>
                                </a>
                            </p>
                            </form>
                        </div>
                        ...
                        <div>
                            <ul>
                                <li class="gras">Frais de livraison <span class="prix gras">{{$fraisLivraison}} €</span></li>
                                <li class="gras">Total <span class="prix">{{ $carts->totalPrice }}&nbsp;€</span></li>
                            </ul>
                        </div>
                    </div>
                    <br>
...
<div>
    @include('layouts.footer')
                    ...
                    <script src="https://js.stripe.com/v3/"></script> <!-- Script stripe -->
                    <script>

                        window.onload = function () {
                            var stripe = Stripe('pk_test_yO2CUtuXDx2HDHF3qEpeGmBC00KdkCaUC5');
                    ...
                    <style>
                        ...
                        input[class="creditCard"]:hover+svg,
                        input[class="creditCard"]:checked+svg,
                        input[class="creditCard"]:focus+svg {}

                        input[class="paypal"]:hover+svg,
                        input[class="paypal"]:checked+svg,
                        input[class="paypal"]:focus+svg {}

                        input[class="apelle"]:hover+svg,
                        input[class="apelle"]:checked+svg,
                        input[class="apelle"]:focus+svg {}

                        input[class="google"]:hover+svg,
                        input[class="google"]:checked+svg,
                        input[class="google"]:focus+svg {}

                        input[class="cash"]:hover+svg,
                        input[class="cash"]:checked+svg,
                        input[class="cash"]:focus+svg {}

                        input[class="ticketRestau"]:hover+svg,
                        input[class="ticketRestau"]:checked+svg,
                        input[class="ticketRestau"]:focus+svg {}
                    </style>
